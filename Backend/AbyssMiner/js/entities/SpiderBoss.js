...
class CrystalMatriarch extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y, player, platforms, playerHitCallback, isIntro = false) {
        ...
        scene.physics.add.existing(this);/AbyssMiner/js/systems/boss.js
        // (已移除强制物理调试绘制 — 尊重全局 debug:false, 不再产生残影)
ed7bd79aeefb9ac8f8741:Backend/AbyssMiner/js/entities/SpiderBoss.js
...
d79aeefb9ac8f8741:Backend/AbyssMiner/js/entities/SpiderBoss.js
        if (!this.active || this.hp <= 0 || this.isReviving || this.isDead) return;
